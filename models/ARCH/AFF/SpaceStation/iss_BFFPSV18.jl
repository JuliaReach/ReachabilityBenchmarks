...
# single run
sol_ISU01_dense = solve(iss_TV, 𝑂_ISU01, op=BFFPSV18(𝑂_dense_ISU))
sol_ISS01_dense = solve(iss_TV, 𝑂_ISS01, op=BFFPSV18(𝑂_dense_ISS01))
sol_ISU01_discrete = solve(iss_TV, 𝑂_ISU01, op=BFFPSV18(𝑂_discrete_ISU))
...
# benchmark
SUITE["ISS"]["ISU01", "dense"] =
    @benchmarkable solve($iss_TV, $𝑂_ISU01, op=BFFPSV18($𝑂_dense_ISU))
SUITE["ISS"]["ISS01", "dense"] =
    @benchmarkable solve($iss_TV, $𝑂_ISS01, op=BFFPSV18($𝑂_dense_ISS01))
SUITE["ISS"]["ISU01", "discrete"] =
    @benchmarkable solve($iss_TV, $𝑂_ISU01, op=BFFPSV18($𝑂_discrete_ISU))
SUITE["ISS"]["ISS01", "discrete"] =
    @benchmarkable solve($iss_TV, $𝑂_ISS01, op=BFFPSV18($𝑂_discrete_ISS01))
...
# single run
sol_ISU02_dense = solve(iss_CONST, 𝑂_ISU02, op=BFFPSV18(𝑂_dense_ISU))
sol_ISS02_dense = solve(iss_CONST, 𝑂_ISS02, op=BFFPSV18(𝑂_dense_ISS02))
sol_ISU02_discrete = solve(iss_CONST, 𝑂_ISU02, op=BFFPSV18(𝑂_discrete_ISU))
...
# benchmark
SUITE["ISS"]["ISU02", "dense"] =
    @benchmarkable solve($iss_CONST, $𝑂_ISU02, op=BFFPSV18($𝑂_dense_ISU))
SUITE["ISS"]["ISS02", "dense"] =
    @benchmarkable solve($iss_CONST, $𝑂_ISS02, op=BFFPSV18($𝑂_dense_ISS02))
SUITE["ISS"]["ISU02", "discrete"] =
    @benchmarkable solve($iss_CONST, $𝑂_ISU02, op=BFFPSV18($𝑂_discrete_ISU))
SUITE["ISS"]["ISS02", "discrete"] =
    @benchmarkable solve($iss_CONST, $𝑂_ISS02, op=BFFPSV18($𝑂_discrete_ISS02))
