...
plot(sol_proj4, tickfont=font(20, "Times"), guidefontsize=30, xlab=L"x_1", ylab=L"x_6",
                xtick=[-0.5, 0.0, 0.5], ytick=[-0.5, 0.0, 0.5],
                bottom_margin=8mm, left_margin=8mm)
savefig("Figure 5 Left.pdf")

plot(sol_proj16, tickfont=font(20, "Times"), guidefontsize=30, xlab=L"x_1", ylab=L"x_{18}",
