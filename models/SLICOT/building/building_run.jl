...
partition = [i:i for i in 1:48]

# reachability algorithms
algorithm_reach = BFFPSV18(:δ => 1e-3, :vars => [25], :partition => partition)
algorithm_check = BFFPSV18(:δ => 2e-3, :vars => [25], :partition => partition)
...
solution.options[:plot_vars] = [0, 25]
